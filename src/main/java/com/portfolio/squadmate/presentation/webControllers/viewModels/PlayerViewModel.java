...
public record PlayerViewModel(Integer id, String firstName, String lastName, int jerseyNumber, String position, boolean isStarter,
String profileImagePath) {
    public static PlayerViewModel from(final Player player){
        return new PlayerViewModel(player.getId(),  player.getFirstName(), player.getLastName(),
